"""Deprecated beta3 compatibility entrypoint for runtime hooks.

The canonical implementation is ``mem_reflection_hermes.runtime_hooks``.
...
_runtime_path = Path(__file__).resolve().parent.parent / "runtime_hooks.py"
