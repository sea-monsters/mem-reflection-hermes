...
try:
    ...
    from .search import _embed_single, _cosine_sim, _extract_keywords, _bm25_search_scored
except ImportError:
    ...
    # Load search.py explicitly to avoid clash with search/ package
    import importlib.util
    _search_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "search.py")
    _search_spec = importlib.util.spec_from_file_location("_reflect_search", _search_path)
